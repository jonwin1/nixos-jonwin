{
  ...
  home-manager.users.${user}.home.packages = with pkgs; [
    ...
    (writeScriptBin "jonwin-launch-or-focus-webapp" (builtins.readFile ./jonwin-launch-or-focus-webapp.sh))
    ...
    (writeScriptBin "jonwin-toggle-idle-inhibitor" (builtins.readFile ./jonwin-toggle-idle-inhibitor.sh))
